...
def main(_) -> None:
    ...
    if _DATASET.value == 'calgary_corpus':
        num_chunks = constants.NUM_CHUNKS_CALGARY
    elif _DATASET.value == 'bible':
        num_chunks = constants.NUM_CHUNKS_BIBLE
    ...
    if _COMPRESSOR.value in compressor.COMPRESSOR_TYPES['classical']:
        ...
        if _DATASET.value == 'enwik9' or 'calgary_corpus' or 'bible':
